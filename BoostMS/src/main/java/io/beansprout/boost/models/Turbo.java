...
public class Turbo implements Serializable {
  ...
  @Column @NotNull private Integer sizeInMM;

  @Column @NotNull private Integer hpMin;
  ...
  @Column @NotNull private String displacement;

  @NotNull @OneToOne private Compressor compressor;

  @NotNull @OneToOne private Turbine turbine;
  ...
  public static class Compressor {
    ...
    @Column @NotNull private Float inducer;

    @Column @NotNull private Float exducer;

    @Column @NotNull private Integer trim;
