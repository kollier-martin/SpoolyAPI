...
/**
 * Custom RuntimeException Inherited from an open code repo and modified for use in this project
 *
...
public class ServiceErrorException extends RuntimeException {
  ...
  public void printStackTrace(PrintWriter s) {
    synchronized (s) {
      ...
      for (StackTraceElement stackTraceElement : trace) s.println("\tat " + stackTraceElement);
